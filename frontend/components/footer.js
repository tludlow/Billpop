            ...
            <div className="max-w-6xl h-full mx-auto flex items-center justify-between">
                <div className="">
                    <li className="flex items-center space-x-3 text-sm">
                        <Link href="/blog">
                            <ul className="cursor-pointer hover:font-semibold focus:shadow-outline" tabIndex="0">
                                Blog
                            </ul>
                        </Link>
                        <Link href="/about">
                        ...
                        <Link href="/press">
                            <ul className="cursor-pointer hover:font-semibold" tabIndex="0">
                                Press
                            </ul>
                        </Link>
                        <Link href="/support">
                ...
                <div className="flex space-x-4 items-center">
                    <svg className="h-4 w-4 text-gray-900" fill="currentColor" viewBox="0 0 20 20" tabIndex="0">
