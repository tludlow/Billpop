            ...
            <div className="">
                ...
                >
                    <div className="h-full container mx-auto grid grid-cols-2">
                        <div className="pl-4 md:pl-0 w-full py-16 space-y-4 my-auto">
                            ...
                            <p>
                                Designer. Preloved. Vintage. Streetwear. Sneakers. <br /> Whatever your style. Find it
                                on Depop.
                            </p>
                            ...
                            <div className="flex space-x-3 ">
                                <button>
                                    <svg
                                        ...
                                        viewBox="0 0 120 40"
                                    >
                                        <title>Download Billpop on the App Store</title>
                                ...
                                <button>
                                    <svg
                                        ...
                                        data-reactid="369"
                                    >
                                        <title>Download Billpop on Google Play</title>
                ...
                <section className="px-4 md:px-0 w-full md:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 my-16 md:my-32">
                    <div className="space-y-6 my-auto order-1 md:order-0">
                        ...
                        <p>
                            Depop is the fashion marketplace app where the next generation come to discover unique
                            items. With a global community buying, selling and connecting to make fashion more
                            inclusive, diverse and less wasteful. This is what transforming fashion looks like.
                        </p>
                ...
                <section className="px-4 md:px-0 w-full md:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 my-24">
                    ...
                    <div className="flex items-center justify-center">
                        <div className="space-y-6">
                            ...
                            <p>
                                Shop the biggest brands you know and love. Discover independent brands making waves and
                                the creators behind them. Whatever you're into, find the item and the seller for you on
                                Depop.
                            </p>
                ...
                <section className="px-4 md:px-0 w-full md:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 my-32">
                    <div className="space-y-6 my-auto order-1 md:order-0">
                        ...
                        <p>
                            Sell a few items or build your empire. Whatever your vibe we’ll share our pro tips to help
                            you get there. It's simple to get started.
                        </p>
