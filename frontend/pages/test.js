    ...
    return (
        <Layout title="Testing - Billpop">
            <div
                ...
                style={{
                    backgroundImage: `url('https://d3170a3msf25m.cloudfront.net/assets/seller/hero@2x.jpg')`,
            ...
            >
                ...
                <div className="flex flex-col justify-center space-y-4">
                    <h2 className="font-extrabold text-4xl">START SELLING</h2>
                    <p className="">
                        Sell clothes. Make money. It's simple to get started. Build <br /> your empire now.
                    </p>
